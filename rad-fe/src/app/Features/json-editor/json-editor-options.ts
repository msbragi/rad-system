...
export class JsonEditorOptions {
  ...
  /**
   * Callback method, triggered on change of contents.
  ...
  /**
   * Callback method, triggered in modes on change of contents,
   * passing the changed contents as JSON.
  ...
  /**
   * Callback method, triggered on node selection change.
   * Only applicable for modes 'tree', 'view', and 'form'.
   */
  public onSelectionChange?: () => void;

  /**
   * Callback method, triggered on text selection change.
   * Only applicable for modes 'code' and 'text'.
   */
  ...
  /**
   * Callback method, triggered when a Node DOM is rendered.
  ...
  constructor(options?: Partial<JsonEditorOptions>) {
