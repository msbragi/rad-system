...
export class JsonEditorComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  public setOptions(newOptions: JsonEditorOptions, merge: boolean = false) {
    if (this.editor) {
      this.editor.destroy();
    }
    this.optionsChanged = true;
    if (merge) {
      this.options = Object.assign(new JsonEditorOptions(), this.options, newOptions);
    } else {
